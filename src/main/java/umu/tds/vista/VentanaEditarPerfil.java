...
/**
 * Ventana para editar el perfil del usuario, permitiendo cambiar la imagen de perfil
 * y mostrando información del usuario.
 */
public class VentanaEditarPerfil extends JDialog {
    ...
    private JPanel crearPanelInformacion() {
        ...
        // Para el saludo/descripción, usar un área de texto para mostrar texto más largo
    ...
    private void cargarImagenActual() {
        ...
        if (imagen != null) {
            ...
            ImageIcon iconoDefecto = new ImageIcon(VentanaEditarPerfil.class.getResource("/umu/tds/resources/usuario.png"));
